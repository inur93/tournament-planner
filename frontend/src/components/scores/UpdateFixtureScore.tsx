...
const UpdateFixtureScore = ({ id, fixture, onSave }: Props) => {
  return (
    <Formik initialValues={fixture} validationSchema={validationSchema} onSubmit={onSave}>
            ...
            <ListItemText>
              <Grid container>
                <Grid item xs={3} sm={2} md={1}>
                  <Input type="number" name="homeScore" disableUnderline value={homeScore} onChange={handleChange} />
                </Grid>
                ...
                <Grid item xs={3} sm={2} md={1}>
                  <Input type="number" name="awayScore" disableUnderline value={awayScore} onChange={handleChange} />
                </Grid>
                <Grid item xs={9} sm={10} md={11} style={{ margin: 'auto 0' }}>
