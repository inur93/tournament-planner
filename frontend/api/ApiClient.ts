...
export class ApiClient {
     ...
     * @return Success
     */
    getTournamentById(id: string , cancelToken?: CancelToken | undefined): Promise<TournamentDetailsDto> {
    ...
    protected processGetTournamentById(response: AxiosResponse): Promise<TournamentDetailsDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = TournamentDetailsDto.fromJS(resultData200);
            return Promise.resolve<TournamentDetailsDto>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<TournamentDetailsDto>(null as any);
    }
     ...
     * @return Success
     */
    createKnockoutTournament(body: KnockoutTournamentForCreation | undefined , cancelToken?: CancelToken | undefined): Promise<TournamentDetailsDto> {
    ...
    protected processCreateKnockoutTournament(response: AxiosResponse): Promise<TournamentDetailsDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
